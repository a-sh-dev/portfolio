...
export const journalDays = [
  ...
  {
    date: format(new Date('2024/7/28'), dateFormat),
    day: differenceInCalendarDays(new Date(2024, 7, 28), circa),
    tag: tags.re,
    code: '',
  ...
  {
    date: format(new Date('2024/7/14'), dateFormat),
    day: differenceInCalendarDays(new Date(2024, 7, 14), circa),
    tag: tags.rd,
    code: '',
    note: `A foo walks into a bar, takes a look around, and then says…`,
    subNote: `"Hello World!"`,
    sub: 'SEO Chatter',
    emoji: emoji('👋'),
  },
  ...
  },
  {
    ...
    tag: tags.ic,
    code: 'scss',
    note: 'CSS preprocessor with programmatic features.',
    emoji: emoji('😍'),
  },
  {
    ...
    tag: tags.ic,
    code: 'ruby',
    note: 'First OOP language. Simple, clean & (almost) everything is an object.',
    emoji: emoji('🤓'),
  },
  {
  ...
  },
  {
    ...
    tag: tags.ic,
    code: 'ruby on rails',
    note: 'Full-stack Ruby framework simplifying modern web apps.',
    emoji: emoji('🚂'),
  },
  {
  ...
  },
  {
    ...
    tag: tags.ex,
    code: 'postgresql',
    note: `Relational database, great for handling complex data.`,
    emoji: emoji('👥'),
  },
  {
  ...
  },
  {
    ...
    tag: tags.mo,
    code: '',
    note: `Embrace "learning by doing" as a team despite not understanding fully, yet.`,
    emoji: emoji('🤔'),
  },
  {
    date: format(new Date('2024/8/26'), dateFormat),
    day: differenceInCalendarDays(new Date(2024, 8, 26), circa),
    tag: tags.ac,
    code: '',
    note: `Accepted into the Apple Foundation Program with RMIT!`,
    emoji: emoji('🍎'),
  },
  {
  ...
  {
    date: format(new Date('2024/8/19'), dateFormat),
    day: differenceInCalendarDays(new Date(2024, 8, 19), circa),
    tag: tags.ex,
    code: 'Go',
    note: `A widely used backend known for its strong support for concurrency.`,
    emoji: emoji('🤩'),
  },
  {
    date: format(new Date('2024/9/2'), dateFormat),
    day: differenceInCalendarDays(new Date(2024, 9, 2), circa),
    tag: tags.ex,
    code: 'Swift',
    note: `Easy and enjoyable to learn - powerful for building Apple apps.`,
    emoji: emoji('📱'),
  },
  {
