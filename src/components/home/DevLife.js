    ...
    <Collapsible color="blue" title="life as a developer">
      <GridContainer flowCol>
        ...
        <GridColumn col="span-8" start="start-1">
          ...
          <Paragraph>
            During project planning and development, I tend to spend
            <em> extra </em>
            time deciding on the branding for the UI, from choosing the right
            font, colours, and image assets to wireframing (including the
          ...
          <Paragraph>
            ...
            when all my folders and files are well organised and named
          ...
          <Paragraph>
            I am also driven by curiosity, eager to learn new things. Somehow, I
            find it enjoyable to read other people&apos;s source code to figure
            out how things work, especially if it would help me code better and
            improve productivity. Therefore, I welcome other people&apos;s
